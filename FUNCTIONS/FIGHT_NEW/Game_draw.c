...
if(!chara->vulnerable)
    al_draw_tinted_scaled_bitmap(res->chara,al_map_rgba(100,0,0,100),180*chara->step,0,180,180,stage->box[chara->x][chara->y]->x,stage->box[chara->x][chara->y]->y,
                      stage->length,stage->length,chara->facingRight);}
...
if(!chara->vulnerable)
    al_draw_tinted_scaled_bitmap(res->chara,al_map_rgba(100,0,0,100),180*chara->step,180,180,180,stage->box[chara->x][chara->y]->x,stage->box[chara->x][chara->y]->y,
                      stage->length,stage->length,chara->facingRight);}
